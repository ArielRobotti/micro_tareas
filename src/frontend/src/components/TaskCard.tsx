        ...
        >
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4 mb-2">
                <div className="flex-1">
                    <h2 className="text-lg sm:text-xl font-semibold text-gray-800 leading-tight mb-1 truncate">{title}</h2>
                    <div className="text-xs text-gray-500 leading-tight mb-1">
                        Published: {createdAt} &nbsp; bids: {bidsCounter}
                    </div>
                </div>
                <div className="flex flex-col items-start sm:items-end gap-2">
                    ...
                    <div className="text-left sm:text-right text-gray-700 font-bold text-lg">{rewardRange[0]} - {rewardRange[1]} USDC</div>
                </div>
            </div>
